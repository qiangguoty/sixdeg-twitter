...
public class Init2NoSplit
{
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		Utilities.createTableNoSplit(Constants.TABLE_NAME, friends, Constants.LOCAL);
		// seen:discovered connections
		Utilities.createTableNoSplit(Constants.SEEN_TABLE_NAME, dummy, Constants.LOCAL);
		...
		job.setJarByClass(Init2NoSplit.class);
